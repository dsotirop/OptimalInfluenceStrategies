function plot_parameters_tuples(Topts,Fvals,Sopts,X,Params,ParamIndices,ConstIndices,ConstValues)
...
if(varying_parameters_num==1)
    % Store separately the indices of the 9 parameters that remain constant.
    ...
    ConstIndex9 = ConstIndices(9);
    % Store separately the names of the 9 parameters that remain constant.
    ...
    Const9Name = ParamsNames{ConstIndex9};
    % Store separately the value strings of the 9 parameters that remain constant.
    ...
    Const9ValueString = num2str(ConstValues(9));
    ...
    TitleString = strcat([Const1Name ' = ' Const1ValueString ' ' Const2Name ' = ' ...
                        ...
                        Const8Name ' = ' Const8ValueString ' ' Const9Name ' = ' Const9ValueString]);
