function [Solutions,Fvals,ExitFlags] = NonLinearObjectiveFunctionMinimizer(Tolerance,Dimensionality,N,lb,ub,Lambda_A_1,Lambda_A_2,Lambda_B_1,Lambda_B_2,Theta1,Theta2,P_A_1,P_A_2,P_B_1,P_B_2,M,K,C,Gamma)
...
options = optimoptions(@fmincon,'Algorithm','sqp','Display','iter-detailed','ConstraintTolerance',tolerance_value,'MaxIterations',1000,'MaxFunctionEvaluations',10000,'StepTolerance',tolerance_value,'OptimalityTolerance',tolerance_value);
