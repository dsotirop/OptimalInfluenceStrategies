% This script estimates the optimal influences T1_opt,T2_opt, Lambda1_opt  
% and Lambda2_opt for a set of given ranges for the optimal influence 
% model parameters defined for the worst case within a 9 dimmensional grid 
% space.
...
% Initialize TL_opts and Fval vectors for storing best values for each
...
ConstValues = [1.0 0.20 0.20 0.40 2.1 0.59 1.0 4.00];
